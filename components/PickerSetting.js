...
import {
  StyleSheet, Modal, Switch, View, Text, Picker,
} from 'react-native';
...
export default class PickerSetting extends PureComponent {
  ...
  render() {
    ...
    const item = this.props.values.find(item => item.value === this.props.value);
    return (
      <View style={{
        flexDirection: 'row', justifyContent: 'space-between', borderWidth: StyleSheet.hairlineWidth, padding: scale(8), alignItems: 'center',
      }}
      >
